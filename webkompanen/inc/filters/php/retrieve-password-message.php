<?php
	...
	add_filter( 'retrieve_password_title', function( $title ){
    	$title = __( 'Wachtwoord resetten ArdoSZ academy' );
    	return $title;
  	});

	function custom_retrieve_password_message($message, $key, $user_login, $user_data){
		//string $message, string $key, string $user_login, WP_User $user_data 
		//if ( in_array( 'ardosz_user', (array) $user_data->roles ) ):
        	//$unique = get_password_reset_key( $user_info );
        	$unique_url = network_site_url('wp-login.php?action=rp&key=' . $key . '&login=' . rawurlencode($user_data->user_login) . '', 'login');
		...
		?>
				...
				<html>
    				<head>
    					...
    					<title>Wachtwoord resetten ArdoSZ academy</title>
        						...
        						<td>
									<center style="width: 100%;">
            							...
            							<div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> 
											Wachtwoord resetten ArdoSZ academy 
										</div>
            							...
            							<table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
            								...
            								<tr>
                								<td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"> 
													<?php echo ucfirst( $user_data->first_name ); ?>,
													<br>
                									<br>
													Iemand heeft verzocht om het wachtwoord van het volgende account opnieuw in te stellen: Sitenaam ArdoSZ. 
                									<br>
                									<br>
                									Gebruikersnaam: <?php echo sprintf(__('%s'), $user_data->user_login) ?>. Bezoek het volgende adres om je wachtwoord in te stellen:
                									<br>
                									<br>
													<?php echo $unique_url; ?>
												</td>
			...
			ob_clean();
			ob_flush();
			//$subject = 'Wachtwoord resetten ArdoSZ academy';
