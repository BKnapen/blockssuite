		...
		?>
				...
				<html>
    				<head>
    					...
    					<title>Logingegevens ArdoSZ academy</title>
            							...
            							<table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
            								...
            								<tr>
                								<td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"> 
													...
													<br>
                									<br>
													Hierbij ontvang je jouw gebruikernaam voor de ArdoSZ academy. 
                									<br>
                									<br>
                									Gebruikersnaam: <?php echo sprintf(__('%s'), $user_info->user_login) ?>. Bezoek het volgende adres om je wachtwoord in te stellen:
                									<br>
                									<br>
													<?php echo $unique_url; ?>
												</td>
			...
			ob_clean();
			ob_flush();
			$subject = 'Logingegevens ArdoSZ academy';
