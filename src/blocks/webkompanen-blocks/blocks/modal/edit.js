...
const sectionEdit = (props) => {
	...
	const arialabelledby = attributes.arialabelledby ? attributes.arialabelledby : null
	...
	blockClasses += attributes.modalshow ? '' : ' modal'
	blockClasses += attributes.modalfade ? ' fade' : ''
			...
			<Fragment>		
				<InspectorControls>
					...
					>
						...
						/>
						<ToggleControl
							label={__('aria hidden', 'webkompanen')}
							help={ attributes.ariahidden ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
						...
						/>
						<ToggleControl
							label={__('Modal show', 'webkompanen')}
							help={ attributes.modalshow ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
							checked={ attributes.modalshow }
							onChange={ 
								(e) => {
									setAttributes({
										modalshow: ! attributes.modalshow
									})
								}
							}
						/>
						<ToggleControl
							label={__('Modal fade', 'webkompanen')}
							help={ attributes.modalfade ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
							checked={ attributes.modalfade }
							onChange={ 
								(e) => {
									setAttributes({
										modalfade: ! attributes.modalfade
									})
								}
							}
						/>
					...
					<PanelBody
						title={__('Block id', 'webkompanen')}
						initialOpen={false}
					>
						<InputControl
							label={__('Block id', 'webkompanen')}
							labelPosition="top"
