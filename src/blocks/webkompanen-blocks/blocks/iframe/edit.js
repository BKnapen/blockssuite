...
const inputEdit = (props) => {
	...
	const title = attributes.title ? attributes.title : null
	const src = attributes.src ? attributes.src : null
	const height = attributes.height ? attributes.height : null
