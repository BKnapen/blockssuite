...
const unorderedListEdit = (props) => {
	...
	const tablecolor  = attributes.color ? ' table-'+attributes.color+'' : '' 
	...
	let blockClasses = 'table'+tablecolor+'';

	blockClasses += classes != null && classes != '' ? ' '+classes : ''
	blockClasses += ratio != null && ratio != '' ? ' '+ratio : ''
	blockClasses += attributes.striped != null && attributes.striped != '' ? ' table-striped' : ''
	blockClasses += attributes.stripedcolumns != null && attributes.stripedcolumns != '' ? ' table-striped-columns' : ''
	blockClasses += attributes.hover != null && attributes.hover != '' ? ' table-hover' : ''
			...
			<Fragment>		
				<InspectorControls>
					...
					>
						...
						/>
						<ToggleControl
							label={__('Responsive table', 'webkompanen')}
							help={ attributes.responsive ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
						...
						/>
						<ToggleControl
							label={__('Striped table', 'webkompanen')}
							help={ attributes.striped ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
						...
						/>
						<ToggleControl
							label={__('Striped columns table', 'webkompanen')}
							help={ attributes.stripedcolumns ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
							checked={ attributes.stripedcolumns }
							onChange={ 
								(e) => {
									setAttributes({
										stripedcolumns: ! attributes.stripedcolumns
									})
								}
							}
						/>
						<ToggleControl
							label={__('Hover table', 'webkompanen')}
							help={ attributes.hover ? __('Yes.', 'webkompanen') : __('No.', 'webkompanen') }
...
export default unorderedListEdit;