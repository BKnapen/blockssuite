...
const sectionEdit = (props) => {
	...
	const ALLOWED_BLOCKS = [ 
		...
		'webkompanen-blocks/dwopdown-menu'
	]
				...
				<InspectorControls>	
					...
					<ToggleControl
						...
						onChange={ 
							(e) => { 
								setAttributes({
									offcanvasstart: ! attributes.offcanvasstart 
								}) 
							}
						}
					/>
					<ToggleControl
						...
						onChange={ 
							(e) => { 
								setAttributes({
									offcanvastop: ! attributes.offcanvastop 
								}) 
							}
						}
					/>
					<ToggleControl
						...
						onChange={ 
							(e) => { 
								setAttributes({
									offcanvasend: ! attributes.offcanvasend 
								}) 
							}
						}
					/>
					<ToggleControl
						...
						onChange={ 
							(e) => { 
								setAttributes({
									offcanvasbottom: ! attributes.offcanvasbottom 
								}) 
							}
						}
					/>
