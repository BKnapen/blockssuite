		...
		elseif ( !current_user_can( 'edit_posts' ) ):
			...
			if ( isset($_POST['action']) ):
				if (  $_POST['action'] == 'log-in' ):
    				...
    				$login = wp_signon( array( 'user_login' => $_POST['user-name'], 'user_password' => $_POST['password'], 'remember' => $_POST['rememberme'] ), '' );
					...
					if($login->ID):
        				...
        				wp_set_auth_cookie( $login->ID, $_POST['rememberme'], '', ''); // Set auth details in cookie
					endif;
