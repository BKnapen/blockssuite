<?php
	function new_training_email($first_name_request, $last_name_request, $email_request, $page_id_request, $token_request){
        	...
        	$site_url = network_site_url().'?token='.$token_request.'';
			$url = untrailingslashit( get_template_directory_uri( __FILE__ ) );
			$path = untrailingslashit( get_template_directory( __FILE__ ) );
			
			$title = get_the_title( $page_id_request );
			$permalink = get_permalink( $page_id_request, false );
			...
			?>
				...
				<html>
    				<head>
    					...
    					<title>Er staat een nieuwe training klaar in de Ardosz Academy</title>
        						...
        						<td>
									<center style="width: 100%;">
            							...
            							<div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> 
											Er staat een nieuwe training klaar in de Ardosz Academy 
										</div>
            							...
            							<table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
            								...
            								<tr>
                								<td style="padding: 40px; text-align: left; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"> 
													...
													<br>
                									<br>
													Graag nodigen wij je hierbij uit voor het ArdoSZ Academy Platform om deel te nemen aan de volgende training(en):
                									<br>
                                                     <?php echo $title; ?>
                									<br>
                                                    <br>
													Klik op onderstaande link om aan je training(en) deel te nemen.
                									<br>
													<?php echo $site_url; ?>
                									<br>
                									<br>
			...
			ob_clean();
			ob_flush();
			$subject = 'Er staat een nieuwe training klaar in de Ardosz Academy';
